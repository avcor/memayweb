...
export default () => {
  return (
      <div style={{backgroundColor: "#6617cb",
      backgroundImage: "linear-gradient(320deg, #6617cb 5%, #cb218e 76%)",
      backgroundSize: "cover",}}>
    <div style={{textAlign: 'left', padding: '2vw 2vw', color: 'ivory'}}>
      <h1><strong><u>Privacy Policy</u></strong></h1>{" "}
      <p>
        Memay built the Memay News app as an Ad Supported app. This SERVICE is
        provided by Memay at no cost and is intended for use as is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at Memay News unless otherwise
      ...
      <p>This policy is effective as of 2020-10-25</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about our Privacy Policy, do
        not hesitate to contact us at memayreal@gmail.com.
      </p>{" "}
      <p>
